...
@Controller('amitajain_quote')
@UseInterceptors(Base64Interceptor)
export class AmitaJainQuoteController {
  constructor(private readonly service: AmitaJainQuoteService) {}
  ...
  async create(
    ...
    try {
      ...
      return {
        message: 'Amita Jain Quote entry added successfully!',
        statusCode: 201,
        data: createdEntry,
      };
    } catch (error) {
  ...
  async update(
    ...
    try {
      ...
      return {
        message: 'Amita Jain Quote  entry updated successfully!',
        statusCode: 200,
        data: updated,
      };
    } catch (error) {
