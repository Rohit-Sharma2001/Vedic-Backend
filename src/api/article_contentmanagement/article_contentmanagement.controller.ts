...
export class ArticleController {
  ...
  async create(
    ...
    try {
      ...
      const result: Partial<Article> = JSON.parse(decodedData);

      // Call the service to create the result
      const createdResult = await this.articleServices.create1(result);
  ...
  async findAll(@Body('data') data: any) {
    try {
      ...
      return this.articleServices.findAll(page, pageSize);
  ...
  async findOne(@Body('data') data: any) {
    try {
      ...
      return this.articleServices.findOneById(id);
  ...
  async update(
    ...
    try {
      ...
      let resultUpdates: Partial<Article>;
      try {
      ...
      const updatedJourney = await this.articleServices.updateJourney(id, resultUpdates);
  ...
  async deleteProduct(@Body('data') data: any) {
    try {
      ...
      return this.articleServices.deleteResult(id);
